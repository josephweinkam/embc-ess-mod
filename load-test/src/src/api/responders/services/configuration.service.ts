...
export class ConfigurationService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  configurationGetAuditOptions$Response(params?: {
  }): Observable<StrictHttpResponse<{
[key: string]: string;
}>> {

    const rb = new RequestBuilder(this.rootUrl, ConfigurationService.ConfigurationGetAuditOptionsPath, 'get');
    if (params) {
    }
   ...
   * This method doesn't expect any request body.
   */
  configurationGetAuditOptions(params?: {
  }): Observable<{
[key: string]: string;
}> {

    return this.configurationGetAuditOptions$Response(params).pipe(
